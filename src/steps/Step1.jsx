...
function Step1({ data,myError, handleChange ,setRecaptchaValue,handleRecaptchaChange}) {
  console.log(myError);
  return (
    <div
      style={{
    ...
    >
      ...
      <ReCAPTCHA name="captcha" sitekey="6Le9_pUnAAAAAPz57O4Vpgy4g3UjG6JICw9MCcLs"  onChange={handleChange} />
